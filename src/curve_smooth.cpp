...
void linearSmooth5(double in[], double out[], int N) {
...

  {
    ...
    out[N - 2] =
        (4.0 * in[N - 1] + 3.0 * in[N - 2] + 2 * in[N - 3] + in[N - 4]) / 10.0;

    out[N - 1] =
        (3.0 * in[N - 1] + 2.0 * in[N - 2] + in[N - 3] - in[N - 5]) / 5.0;
  }
}
...
void linearSmooth7(double in[], double out[], int N) {
...

  {
    ...
    out[N - 3] =
        (7.0 * in[N - 1] + 6.0 * in[N - 2] + 5.0 * in[N - 3] +
...
void quadraticSmooth5(double in[], double out[], int N) {
  ...
  {
    out[0] =
        (31.0 * in[0] + 9.0 * in[1] - 3.0 * in[2] - 5.0 * in[3] + 3.0 * in[4]) /
        35.0;

    out[1] =
        (9.0 * in[0] + 13.0 * in[1] + 12 * in[2] + 6.0 * in[3] - 5.0 * in[4]) /
        35.0;
    ...
    out[N - 2] = (9.0 * in[N - 1] + 13.0 * in[N - 2] + 12.0 * in[N - 3] +
                  6.0 * in[N - 4] - 5.0 * in[N - 5]) /
                 35.0;

    out[N - 1] = (31.0 * in[N - 1] + 9.0 * in[N - 2] - 3.0 * in[N - 3] -
                  5.0 * in[N - 4] + 3.0 * in[N - 5]) /
                 35.0;
  }
}
...
void quadraticSmooth7(double in[], double out[], int N) {
...

  {
    ...
    out[N - 3] = (1.0 * in[N - 1] + 3.0 * in[N - 2] + 4.0 * in[N - 3] +
                  ...
                  4.0 * in[N - 4] + 3.0 * in[N - 5] + 1.0 * in[N - 6] -
                  2.0 * in[N - 7]) /
                 14.0;
    ...
    out[N - 1] = (32.0 * in[N - 1] + 15.0 * in[N - 2] + 3.0 * in[N - 3] -
                  ...
                  4.0 * in[N - 4] - 6.0 * in[N - 5] - 3.0 * in[N - 6] +
                  5.0 * in[N - 7]) /
                 42.0;
  }
}

// cubicSmooth.c 三次函数拟合平滑
/**

* 五点三次平滑

*
以五点三次平滑为例。取相邻的5个数据点，可以拟合出一条3次曲线来，然后用3次曲线上相应的位置的数据值作为滤波后结果。
...
void cubicSmooth5(double in[], double out[], int N)
{
  ...
  {
    out[0] =
        (69.0 * in[0] + 4.0 * in[1] - 6.0 * in[2] + 4.0 * in[3] - in[4]) / 70.0;
...

{
...

  {
    ...
    out[N - 3] = (-4.0 * in[N - 1] + 16.0 * in[N - 2] + 19.0 * in[N - 3] +
                  ...
                  12.0 * in[N - 4] + 2.0 * in[N - 5] - 4.0 * in[N - 6] +
                  1.0 * in[N - 7]) /
                 42.0;

    out[N - 2] = (8.0 * in[N - 1] + 19.0 * in[N - 2] + 16.0 * in[N - 3] +

                  6.0 * in[N - 4] - 4.0 * in[N - 5] - 7.0 * in[N - 6] +
                  4.0 * in[N - 7]) /
                 42.0;

    out[N - 1] = (39.0 * in[N - 1] + 8.0 * in[N - 2] - 4.0 * in[N - 3] -

                  4.0 * in[N - 4] + 1.0 * in[N - 5] + 4.0 * in[N - 6] -
                  2.0 * in[N - 7]) /
                 42.0;
  }
}