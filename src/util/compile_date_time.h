...
/**
 * @file compile_date_time.h
 * @brief 处理宏 __DATE__ 和 __TIME__.
 * @author wxliu (wxliu8@sina.com)
 * @date 2024-1-10
 * @copyright Copyright (c) 2024-present, Wenxue Liu.
 * 
 */

#ifndef _COMPILE_DATE_TIME_H_
#define _COMPILE_DATE_TIME_H_
